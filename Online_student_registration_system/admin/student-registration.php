...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" id="studentregno" name="studentregno" onBlur="userAvailability()" placeholder="Student Admission No." required />
...
<div class="form-group">
    ...
    <input type="password" class="form-control" id="password" name="password" placeholder="Student Password" required />
  </div>

<center> <button type="submit" name="submit" id="submit" class="btn btn-default" >Save </button></center>
</form>
                            </div>
                            </div>
                    </div>
