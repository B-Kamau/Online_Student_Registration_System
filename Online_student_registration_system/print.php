...
<body>
  <center> <p style="color:blue; font-size:25px;"><img src="logo.png" alt="OSRS" id="logo" height="100px"> <br>
   <b> ONLINE STUDENT REGISTRATION SYSTEM (OSRS) <hr style="height:4px;background:black;"> </b>  </center></p>
   <b>Student Registration Slip</b>
                ...
                <td colspan="2">
                    <table>
                        <tr>
                            <td class="title">
                                  <?php if($row['photo']==""){ ?>
   <img src="studentphoto/noimage.png" width="100" height="100"><?php } else {?>
   <img src="studentphoto/<?php echo htmlentities($row['photo']);?>" width="150" height="150">
   <?php } ?>
                            </td>

                            <td id="topheader">
                               <b><strong>Student Admission No:</strong> </b><?php echo htmlentities($_SESSION['login']);?><br>
                               <b> <strong>Student Name:</strong> </b>  <?php echo htmlentities($row['studentname']);?><br>
                               <b><strong>Student Reg. Date:</strong> </b> <?php echo htmlentities($row['studentregdate']);?><br>
                                <b> <strong>Student Course Enroll Date:</strong></b> <?php echo htmlentities($row['edate']);?><br>
                                <b> <strong>Student Gender: </strong></b> Male <br>
                                <b> <strong>Student Telephone No : </strong></b> +254746385938 <br>
                                <b> <strong>Student Email Address : </strong></b> blessedkamau4@gmail.com <br>
                            </td>
                        </tr>
                    </table>
                </td>
 ...
 <tr class="item">
    ...
    <table>
      <tr>
        ...
        <td>  <img src="signature.png" height="45px" alt="sign"></td>
      </tr>
      <tr>
        <td></td>
      </tr>
      <tr>
        <td> <b>  Registrar Approval : </b> </td>
        <td><img src="approved.png" alt="approved" height="100px" width="160px"></td>
      </tr>
    </table>
     </body>
</html>
